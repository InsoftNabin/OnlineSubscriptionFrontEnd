...
! function (a) {
    ...
    "function" == typeof define && define.amd ? define(["jquery"], function (b) {
        ...
        "object" == typeof exports ? module.exports = function (b, c) {
            return b || (b = window), c ||
                (c = "undefined" != typeof window ? require("jquery") : require("jquery")(b)), a(c, b, b.document)
    ...
    function f(b, c, g) {
        ...
        a.each(c, function (e, i) {
            h = b._hungarianMap[e], h === d ||
                !g && c[h] !== d || ("o" === h.charAt(0) ? (c[h] || (c[h] = {}), a.extend(!0, c[h], c[e]), f(b[h], c[h], g)) : c[h] = c[e])
        })
    }
    ...
    function I(b, d, e, f) {
        var ColumnCount = a("#dynamic-table").find("thead").find("th").length;
        var g, h, i, j, k, l = b.aoData[d],
            m = l._aData,
            n = [];
        if (null === l.nTr) {
            for (g = e || c.createElement("tr"), l.nTr = g, l.anCells = n, g._DT_RowIndex = d, J(b, l), j = 0, k = ColumnCount; k > j; j++) i = b.aoColumns[j], h = e ? f[j] : c.createElement(i.sCellType), h._DT_CellIndex = {
                row: d,
                column: j
    ...
    function qa(b) {
        ...
        }, g), F.outerWidth() < l ? (k = y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y") ? l + s : l, K && (y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y")) && (H.width = xa(k - s)), "" !== p && "" === q || Ia(b, 1, "Possible column misalignment", 7)) : k = "100%", A.width = xa(k), u.width = xa(k), I && (b.nScrollFoot.style.width = xa(k)), r || K && (A.height = xa(G.offsetHeight + s));
        var T = F.outerWidth();
